          ...
          <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <form className="space-y-6" method="POST">
              ...
              <div>
                ...
                <div className="mt-2">
                <select className="block w-full rounded-md border-1 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                      <option ref={role}>Admin</option>
                      <option ref={role}>Manager</option>
                      <option ref={role}>Member</option>
                </select>
                </div>
              </div>
